...
<% 
    ...
    <div class="page-body breadcrumb-page">
        <div class="card page-header p-0">
            <div class="card-block front-icon-breadcrumb  align-items-end" style="padding:0;">
                <div class="row">
                    <div class="breadcrumb-header col-md-4 col-lg-2">
                        <div class="big-icon">
                    ...
                    <div class="d-inline-block col-md-6"><br /><br />
                            <h5 style="font-size:15px;"><%=firma("firma_adi") %></h5>
                            <span><%=firma("firma_yetkili") %></span><br /><br />
                    </div>
                </div>
                <div class="col" style="display:none;">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            <li class="breadcrumb-item"><a href="javascript:void(0);" class="btn btn-success btn-round" style="color: white;"><i class="fa  fa-cube"></i>&nbsp;<%=LNG("Taşeron Bilgilerini Düzenle")%></a>
                            </li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);" class="btn btn-danger btn-round" style="color: white;"><i class="fa fa-search"></i>&nbsp;<%=LNG("Taşeron Sil")%></a>
                            </li>
    ...
    <div class="col-lg-12">
        <div class="tabs tabs-style-bar">
            ...
            <% if trim(yetki_kodu)="TASERON" then %>
                    ...
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",31,")>0 then %>
                    ...
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",32,")>0 then %>
                    ...
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",33,")>0 then %>
                    ...
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",34,")>0 then %>
                    ...
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",35,")>0 then %>
                    ...
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",36,")>0 then %>
        ...
        <% else %>
                    ...
                    <li class="nav-link_yeni"><a href="#cari_hareketler" onclick="musteri_cari_hareketleri_getir('<%=firma_id %>', this);" class="icon icon-box"><span><%=LNG("Cari Hareketler")%></span></a></li>
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",6,")>0 then %>                    
                    <li class="nav-link_yeni"><a href="#dosyalar" onclick="musteri_dosyalari_getir('<%=firma_id %>', this);" class="icon icon-upload"><span><%=LNG("Dosyalar")%></span></a></li>
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",7,")>0 then %>
                    <li class="nav-link_yeni"><a href="#ajanda" onclick="musteri_ajanda_getir('<%=firma_id %>', this);" class="icon icon-tools"><span><%=LNG("Ajanda")%></span></a></li>
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",8,")>0 then %>
                    <li class="nav-link_yeni"><a href="#is_listesi_panel" onclick="musteri_is_listesi_getir('<%=firma_id %>', this);" class="icon icon-home"><span><%=LNG("İş Listesi")%></span></a></li>
                    <% end if %>
                    <% if instr(Request.Cookies("kullanici")("yetkili_sayfalar"), ",9,")>0 then %>
