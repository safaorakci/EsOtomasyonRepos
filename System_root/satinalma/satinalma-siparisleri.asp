...
<style>
    ...
    #simpletable thead tr th, #simpletable tbody tr td {
        ...
        <article class="col-xs-12 ">
            <div class="card">
                <div class="card-header">
                    ...
                    <input type="button" style="float: right; margin-right:15px;" class="btn btn-info" onclick="ModalSatinalmaArama();" value="Arama Yap" />
                </div>
                <div class="card-block">
                    <div class="row">
                        <div id="satinalma_listesi" class="col-md-12">
                           <script>
                               $(function (){
                                    satinalma_listesi_getir();
                               });
                           </script>
                        </div>
                    </div>
