...
<html lang="tr">
<head>
    <title><%=LNG("Ödemeler Raporu")%></title>
...
<body>
    ...
    <div>
        ...
        <fieldset visible="true" style="border: 1px solid #cccccc; padding: 15px; margin-bottom: 15px;">
            <div class="dt-responsive table-responsive">
                <table class="table " style="border: solid 1px #ccc; width:100%;" cellpadding="0" cellspacing="0" border="1">
                    <thead>
                        <tr>
                            <th style="padding: 10px; font-weight: bold; font-size: 15px; color: #495057; background-color: #e9ecef!important;"><%=LNG("ÖDEME TİPİ")%></th>
                            <th style="text-align: center; padding:10px; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #4099ff, #73b4ff); width: 150px;"><span class="label label-primary arkaplansiz badge-lg">TL <%=LNG("ÖDEME")%></span></th>
                            <th style="padding: 10px; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #FF5370, #ff869a); width: 150px;"><span class="label label-danger arkaplansiz badge-lg ">$ <%=LNG("ÖDEME")%></span></th>
                            <th style="padding: 10px; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #FFB64D, #ffcb80); width: 150px;"><span class="label label-warning arkaplansiz badge-lg">€ <%=LNG("ÖDEME")%></span></th>
        ...
        <br />
        <fieldset visible="true" style="border: 1px solid #cccccc; padding: 15px; margin-bottom: 15px;">
            <h3><%=LNG("ÖDEME LİSTESİ")%></h3>
            <div class="dt-responsive table-responsive">
                <table class="table " style="border: solid 1px #ccc; width:100%;" cellpadding="0" cellspacing="0" border="1">
                    <thead>
                        <tr>
                            <th style="padding: 10px; font-weight: bold; font-size: 15px; color: #495057; background-color: #e9ecef!important;"><%=LNG("ÖDEME TARİHİ")%></th>
                    ...
                    <tbody>
                        ...
                        <%
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="6" style="text-align:center; padding:10px;"><%=LNG("Kayıt Yok")%></td>
                                    </tr>
                                    <%
                                        end if
                                        do while not cek.eof
