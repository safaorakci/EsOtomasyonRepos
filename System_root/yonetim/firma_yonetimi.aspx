<%@ Page Language="C#" AutoEventWireup="true" CodeFile="firma_yonetimi.aspx.cs" Inherits="System_root_yonetim_firma_yonetimi" %>
...
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><% Response.Write(LNG("Demo Kullanan Firma Listesi")); %></h5>
                </div>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><% Response.Write(LNG("Demo Hesap Gönder")); %></h5>
                </div>
                <div class="card-block">
                    ...
                    <div class="row modal-footer" style="margin-top: 20px;">
                        <input type="button" onclick="yeni_firma_ekle('BOSS');" class="btn btn-primary" value="<% Response.Write(LNG("Firma Ekle")); %>" />
                    </div>
                </div>
            </div>
