        ...
        <article class="col-xs-12 ">
            <div class="card">
                <div class="card-header">
                    <h5><%=LNG("Genel Personel Puantaj Raporu")%></h5>
                </div>
                <div class="card-block">
                    <div class="row">
                        ...
                        <div class=" col-sm-12 col-md-1">
                            <a class="btn btn-labeled btn-primary btn-mini mt-2" style="margin-top: 20px !important" onclick="personel_giris_cikis_getir_rapor();" href="javascript:void(0);"><span class="btn-label"><i class="fa fa-download"></i></span><%=LNG("Sorgula")%></a>
                        </div>

                        <div class=" col-sm-12 col-md-12">
                            <div class="float-right mt-2">
                                <a class="btn btn-labeled btn-success btn-mini mr-1 text-white mt-1" style="color:white" onclick="exportToExcel();"><span class="btn-label"><i class="fa fa-file-excel-o"></i></span><%=LNG("Export To Excell")%> </a>
                    ...
                    <div class="row">
                        <div class="col-xs-12" id="personel_giris_cikis_donus">
                            <script type="text/javascript">
                                $(function () {
                                    personel_giris_cikis_getir_rapor();
                                });
                            </script>
                        </div>
                    </div>
...
<script type="text/javascript">
    function exportToExcel() {
        $("#tablegosterge").table2excel({
            ...
            filename: "PersonelGenelPuantajRaporu" //burada .(nokta) ve uzantı kullanmayın,
        });
    }
</script>