...
<script type="text/javascript">
    $(function () {
        rapor_is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');
    });
</script>
            ...
            $(this).removeClass("ustunegelince2");
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2">
                                ...
                                <select name="yeni_is_yuku_gosterim_tipi" class="select2" onchange="rapor_is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');" id="yeni_is_yuku_gosterim_tipi">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <%=LNG("Proje")%><br />
                                <select name="yeni_is_yuku_proje_id" class="select2" id="yeni_is_yuku_proje_id" onchange="rapor_is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');">
                            ...
                            <div class="col-sm-12 col-md-2">
                                <%=LNG("Dönem")%><br />
                                <select name="rapor_is_yuku_donem" class="select2" id="rapor_is_yuku_donem" onchange="rapor_is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');">
                                    <% for x = 1 to 12 
                            ...
                            <div class="col-sm-12 col-md-6 align-self-end mt-2">
                                <div class="float-right">
                                    <a class="btn btn-labeled btn-success btn-sm mr-1 text-white" onclick="rapor_pdf_indir('personel_is_yuku');" ><span class="btn-label"><i class="fa fa-download"></i></span><%=LNG("İndir")%> </a>
                                    <a class="btn btn-labeled btn-warning btn-sm mr-1 text-white" onclick="rapor_pdf_yazdir('personel_is_yuku');"><span class="btn-label"><i class="fa fa-print"></i></span><%=LNG("Yazdır")%> </a>
                                    <a class="btn btn-labeled btn-primary btn-sm text-white" onclick="rapor_pdf_gonder('personel_is_yuku');"><span class="btn-label"><i class="fa fa-send "></i></span><%=LNG("Gönder")%> </a>
                                </div>
                            </div>
