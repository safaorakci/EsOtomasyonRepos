...
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><% Response.Write(LNG("Görev Ekle")); %></h5>
                </div>
                <div class="card-block">

                    <form id="gorev_ekle_form">
                        <div class="row">
                            <label class="col-sm-12  col-lg-12 col-form-label"><% Response.Write(LNG("Görev Adı")); %></label>
                    ...
                    <div class="row modal-footer" style="margin-top:20px;">
                            <input type="button" class="btn btn-primary" onclick="gorev_ekle();" value="<% Response.Write(LNG("Görev Ekle")); %>" />
                    </div>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5><% Response.Write(LNG("Görev Listesi")); %></h5>
                </div>
                <div class="card-block">
