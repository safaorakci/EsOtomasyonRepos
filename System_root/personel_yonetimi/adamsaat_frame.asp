...
<body>
    <div class='container'>
        ...
        <script>
            ...
            <%
                SQL="select * from ucgem_proje_listesi where durum = 'true' and cop = 'false' and santiye_durum_id = '6' order by proje_adi asc"
                set projeler = baglanti.execute(SQL)
                do while not projeler.eof
            %>
                ['<%=projeler("proje_adi") %>', 7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6, 7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6],
            <%
                projeler.movenext
                loop
            %>
                ['<strong><%=LNG("TOPLAM")%></strong>', 13.9, 14.2, 15.7, 18.5, 111.9, 115.2, 117.0, 116.6, 114.2, 110.3, 16.6, 14.8, 13.9, 14.2, 15.7, 18.5, 111.9, 115.2, 117.0, 116.6, 114.2, 110.3, 16.6, 14.8],
                ['<strong><%=LNG("MALİYET")%></strong>', 213.9, 114.2, 115.7, 218.5, 2111.9, 3115.2, 4117.0, 5116.6, 6114.2, 7110.3, 216.6, 214.8, 213.9, 332.2, 115.7, 118.5, 2111.9, 2115.2, 2117.0, 2116.6, 2114.2, 2110.3, 216.6, 214.8],
            ];
            ...
            $('#my').jexcel({
                data: data,
                onchange: update,
                colHeaders: ['<%=LNG("ÇALIŞANLAR")%>', '01.01.2018', '02.01.2018', '03.01.2018', '04.01.2018', '05.01.2018', '06.01.2018', '07.01.2018', '08.01.2018', '09.01.2018', '10.01.2018', '11.01.2018', '12.01.2018', '13.01.2018', '14.01.2018', '15.01.2018', '16.01.2018', '17.01.2018', '18.01.2018', '19.01.2018', '20.01.2018', '21.01.2018', '22.01.2018', '23.01.2018', '24.01.2018'],
