<%@ Page Language="C#" AutoEventWireup="true" CodeFile="is_listesi2.aspx.cs" Inherits="System_root_is_listesi_is_listesi2" %>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 ">
                ...
                <div class="btn btn-warning btn-lg btn-block" style="padding: 3px 16px; -webkit-border-top-left-radius: 15px; -webkit-border-top-right-radius: 15px; -moz-border-radius-topleft: 15px; -moz-border-radius-topright: 15px; border-top-left-radius: 15px; border-top-right-radius: 15px; font-size:13px;">
                    <span onclick="is_listesi_gosterge('departman_tumu');"><i class="fa fa-institution"></i>&nbsp;&nbsp;<% Response.Write(LNG("Etiketler :")); %> </span><span id="yerlesim_item">
                ...
                <div class="col">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            <li class="breadcrumb-item"><a href="javascript:void(0);" onclick="yeni_is_ekle();" class="btn btn-success btn-round" style="color: white; display:none;"><i class="fa  fa-cube"></i>&nbsp;<% Response.Write(LNG("Yeni İş Emri Ekle")); %></a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xl-12">
                                ...
                                <ul class="nav nav-tabs tabs is_tab" role="tablist" style="text-align-last: justify">
                                    ...
                                    <li class="nav-item" style="text-align-last: left">
                                ...
                                <div class="tab-content tabs card-block" style="padding:0!important; border-left:1px solid #ddd;">
                                    ...
                                    <div class="tab-pane " id="geciken_isler_ust" role="tabpanel">
                                            ...
                                            <br><table style=" width:100%; height:100%;"><tr><td style=" text-align:center; vertical-align:middle;"><div class="cell preloader5 loader-block"><div class="circle-5 l"></div><div class="circle-5 m"></div><div class="circle-5 r"></div></div></td></tr></table>
                                        </div>
