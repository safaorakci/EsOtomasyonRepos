        ...
        <div class="widget-body">
            <div class="tabs-top">
                ...
                <div class="tab-content tabs card-block">
                    <div class="tab-pane" id="tab-r5" role="tabpanel"><br />
                        <div id="parcalar_iscilik_donus_yeri<%=is_id %>"></div>
                    </div>
                    <div class="tab-pane active" id="tab-r1" role="tabpanel"><br />
                        ...
                        <div class="row">
                            <div class="col-xs-3">
                                <a rel="tooltip" data-original-title="<%=gorevli("personel_adsoyad") %>" data-placement="top" href="javascript:void(0)">
                                    <img style="max-width:80px; min-width: 21px;" src="<%=gorevli("personel_resim") %>" class="online">
                                </a>
                            </div>
                            ...
                            <div class="col-xs-9">
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <input type="button" tamamlanmaid="<%=gorevli("id") %>" is_id="<%=is_id %>" class="startButton btn btn-success btn-lg mb-1 btn-sm" value="Başlat" style="margin-top: -15px;" />
                                    <input type="button" tamamlanmaid="<%=gorevli("id") %>" baslik="<%=gorevli("adi") %>" aciklama="<%=gorevli("adi") %> adlı işte ilerleme kaydedildi." is_id="<%=is_id %>" class="pauseButton btn btn-primary btn-sm btn-lg mb-1" value="Duraklat" style="margin-top: -15px;" />
                                    <input type="button" tamamlanmaid="<%=gorevli("id") %>" is_id="<%=is_id %>" class="stopButton btn btn-danger btn-lg mb-1 btn-sm" value="Tamamlandı" style="margin-top: -15px;" />
                                </div>
                                <% else %>
                              <%=LNG("İşin Tamamlanma Durumu1 :")%>
                                <br />
                                <div class="nprogress">
                    ...
                    <div class="tab-pane" id="tab-r2" role="tabpanel"><br />
                    ...
                    <div class="tab-pane" id="tab-r3" role="tabpanel"><br />
                        <div class="row">
                            <br />
