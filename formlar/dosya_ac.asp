        ...
        if cdbl(gp(4))>0 then
            ...
            if dosya.eof then
                ...
                if trim(dosya_tipi)="doc" or trim(dosya_tipi)="docx" or trim(dosya_tipi)="xls" or trim(dosya_tipi)="xlsx" or trim(dosya_tipi)="ppt" or trim(dosya_tipi)="pptx" then
                    Response.redirect "https://view.officeapps.live.com/op/view.aspx?src=http%3A%2F%2Fhttp://http://localhost:52225"& replace(dosya("depo_dosya_yolu"), "/", "%2F")
                elseif trim(dosya_tipi)="pdf" then
                    Response.Redirect "http://localhost:52225" & dosya("depo_dosya_yolu")
