    ...
    return function(t) {
        ...
        (function(t) {
            ! function(e, i) {
                ...
                var _n = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                    wn = "Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık".split("_"),
                    xn = "Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara".split("_"),
                    Dn = rn,
                    Sn = rn;
                ...
                var Cn = "Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),
                    Tn = "Paz_Pts_Sal_Çar_Per_Cum_Cts".split("_"),
                    Mn = "Pz_Pt_Sa_Ça_Pe_Cu_Ct".split("_"),
                    On = rn,
                    En = rn,
                    Pn = rn;
                ...
                var In, Nn = /[ap]\.?m?\.?/i,
                    ...
                    Wn = /^\/?Date\((\-?\d+)/i,
                    Vn = /^(?:(Pts|Sal|Çar|Per|Cum|Cmt|Pzr),?\s)?(\d{1,2})\s(Ock|Şub|Mar|Nis|May|Haz|Tem|Ağu|Eyl|Ekim|Kas|Ara)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/,
                    Bn = {
                        UT: 0,
                        GMT: 0,
                        EDT: -240,
