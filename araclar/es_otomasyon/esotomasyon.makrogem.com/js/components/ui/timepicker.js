    ...
    $.extend(Timepicker.prototype, {
        ...
        _injectTimePicker: function () {
            ...
            if ($dp.find("div#ui-timepicker-div-" + dp_id).length === 0 && o.showTimepicker) {
				...
				html = '<div class="ui-timepicker-div" id="ui-timepicker-div-' + dp_id + '"><dl style="padding-left:6px; padding-right:6px;">' +
						'<dt class="ui_tpicker_time_label" id="ui_tpicker_time_label_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '><div class="labelTimeSelect">' + o.timeText + '</div></dt>' +
						'<dd class="ui_tpicker_time" id="ui_tpicker_time_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '></dd>' +
						'<dt class="ui_tpicker_hour_label" id="ui_tpicker_hour_label_' + dp_id + '"' +
						((o.showHour) ? '' : noDisplay) + '><div style="margin-bottom:8px;" class="labelTime">' + o.hourText + '</div></dt>',
				hourGridSize = 0,
				minuteGridSize = 0,
				secondGridSize = 0,
				millisecGridSize = 0,
                ...
                html += '<dt class="ui_tpicker_minute_label" id="ui_tpicker_minute_label_' + dp_id + '"' +
					((o.showMinute) ? '' : noDisplay) + '><div style="margin-top:8px; margin-bottom:8px;" class="labelTime">' + o.minuteText + '</div></dt>';
