...
(function ($) {
    ...
    $.widget('ui.spinner', {
        ...
        _setValue: function (newVal) {
            ...
            if (this.element.attr("id") == "oda1cocuk") {
                cocuk_yasalari_degis(1, newVal);
            }


            if (this.element.attr("id") == "tur_oda1cocuk") {
                tur_cocuk_yasalari_degis(1, newVal);
            }

            if (this.element.attr("id") == "transfer_bebek") {
                transfer_bebek_yasalari_degis(newVal);
            }

            if (this.element.attr("id") == "transfer_cocuk") {
                transfer_cocuk_yasalari_degis(newVal);
            }

            if (this.element.attr("id") == "gece_sayisi") {
                gece_sayisi_degis(newVal);
            }


            if (this.element.attr("id") == "oda1bebek") {
                bebek_yasalari_degis(1, newVal);
            }
            if (this.element.attr("id") == "oda2bebek") {
                bebek_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "oda3bebek") {
                bebek_yasalari_degis(3, newVal);
            }


            if (this.element.attr("id") == "oda2cocuk") {
                cocuk_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "oda3cocuk") {
                cocuk_yasalari_degis(3, newVal);
            }
            if (this.element.attr("id") == "oda4cocuk") {
                cocuk_yasalari_degis(4, newVal);
            }


            if (this.element.attr("id") == "cruise_oda1bebek") {
                cruise_bebek_yasalari_degis(1, newVal);
            }
            if (this.element.attr("id") == "cruise_oda2bebek") {
                cruise_bebek_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "cruise_oda3bebek") {
                cruise_bebek_yasalari_degis(3, newVal);
            }


            if (this.element.attr("id") == "cruise_oda1cocuk") {
                cruise_cocuk_yasalari_degis(1, newVal);
            }
            if (this.element.attr("id") == "cruise_oda2cocuk") {
                cruise_cocuk_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "cruise_oda3cocuk") {
                cruise_cocuk_yasalari_degis(3, newVal);
            }
            if (this.element.attr("id") == "cruise_oda4cocuk") {
                cruise_cocuk_yasalari_degis(4, newVal);
            }



            if (this.element.attr("id") == "tur_oda1bebek") {
                tur_bebek_yasalari_degis(1, newVal);
            }
            if (this.element.attr("id") == "tur_oda2bebek") {
                tur_bebek_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "tur_oda3bebek") {
                tur_bebek_yasalari_degis(3, newVal);
            }


            if (this.element.attr("id") == "tur_oda2cocuk") {
                tur_cocuk_yasalari_degis(2, newVal);
            }
            if (this.element.attr("id") == "tur_oda3cocuk") {
                tur_cocuk_yasalari_degis(3, newVal);
            }
            if (this.element.attr("id") == "tur_oda4cocuk") {
                tur_cocuk_yasalari_degis(4, newVal);
            }

            if (this.element.attr("id") == "tekneyatkabinsayisi") {
                kabin_sayisi_degis(newVal);
            }

            if (this.element.attr("id") == "oda_sayisi") {

                oda_sayisi_degis(newVal);

            }

            if (this.element.attr("id") == "cruise_oda_sayisi") {
                cruise_oda_sayisi_degis(newVal);
            }

            if (this.element.attr("id") == "tur_oda_sayisi") {

                tur_oda_sayisi_degis(newVal);
