                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" style="padding: 0; padding-left: 10px; height: 150px;">
                            <div class="row" style="padding: 0;">
                                <div class="col-xs-12" style="padding: 10px;">
                                    <center>
                                <h5 style="font-weight:300; line-height:45px;"><i class="fa fa-money"></i> <%=LNG("TOPLAM TAHSİLAT")%></h5>
                            </center>
                                </div>
                            </div>
                            <div class="row align-items-center" style="padding: 0; padding-top: 15px;">
        ...
        <article class="col-xs-12 ">
            <div class="card">
                ...
                <div style="float: right;">
                                <a class="btn btn-labeled btn-success btn-sm" href="javascript:void(0);" onclick="rapor_pdf_indir('tahsilatlar_raporu');" style="margin-top: -27px;"><span class="btn-label"><i class="fa fa-download"></i></span><%=LNG("İndir")%> </a>&nbsp;&nbsp;<a class="btn btn-labeled btn-warning btn-sm" href="javascript:void(0);" onclick="rapor_pdf_yazdir('tahsilatlar_raporu');" style="margin-top: -27px;"><span class="btn-label"><i class="fa fa-print"></i></span><%=LNG("Yazdır")%> </a>&nbsp;&nbsp;<a class="btn btn-labeled btn-primary btn-sm" href="javascript:void(0);" onclick="rapor_pdf_gonder('tahsilatlar_raporu');" style="margin-top: -27px;"><span class="btn-label"><i class="fa fa-send "></i></span><%=LNG("Gönder")%> </a>
                            </div>
                    </div>
                <div id="beta_donus" class="card-block">
                    <fieldset visible="true" style="border: 1px solid #cccccc; padding: 15px; margin-bottom: 15px;">
                        <legend style="width: auto; padding-left: 5px; padding-right: 5px; font-size: 15px;"><%=LNG("TAHSİLATLAR RAPORU")%></legend>
                        <div class="dt-responsive table-responsive">
                            <table class="table " style="border: solid 1px #ccc;" border="1">
                                <thead>
                                    <tr>
                                        <th style="padding: .75rem; font-weight: bold; font-size: 15px; color: #495057; background-color: #e9ecef!important;"><%=LNG("Tahsilat Tipi")%></th>
                                        <th style="text-align: center; padding: .75rem; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #4099ff, #73b4ff); width: 150px;"><span class="label label-primary arkaplansiz badge-lg">TL <%=LNG("TAHSİLAT")%></span></th>
                                        <th style="padding: .75rem; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #FF5370, #ff869a); width: 150px;"><span class="label label-danger arkaplansiz badge-lg ">$ <%=LNG("TAHSİLAT")%></span></th>
                                        <th style="padding: .75rem; font-weight: bold; font-size: 15px; background: linear-gradient(45deg, #FFB64D, #ffcb80); width: 150px;"><span class="label label-warning arkaplansiz badge-lg">€ <%=LNG("TAHSİLAT")%></span></th>
...
if girdimi then
                    ...
                    <br /><hr /><br />
                    <fieldset visible="true" style="border: 1px solid #cccccc; padding: 15px; margin-bottom: 15px;">
                        <legend style="width: auto; padding-left: 5px; padding-right: 5px; font-size: 15px;"><%=LNG("TAHSİLAT LİSTESİ")%></legend>
                        <div class="dt-responsive table-responsive">
                            <table class="table " style="border: solid 1px #ccc;" border="1">
                                <thead>
                                    <tr>
                                        <th style="padding: .75rem; font-weight: bold; font-size: 15px; color: #495057; background-color: #e9ecef!important;"><%=LNG("Tahsilat Tarihi")%></th>
