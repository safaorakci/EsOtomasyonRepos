        ...
        <article class="col-xs-12 ">
            <div class="card">
                <div class="card-header">
                    <h5><%=LNG("Departman Adam-Saat Raporu")%></h5>
                </div>
                <div class="card-block">
                    <div class="row">
                        ...
                        <div class="col-sm-1 col-md-1">
                            <a class="btn btn-labeled btn-primary btn-sm" onclick="departman_adam_saat_getir();" href="javascript:void(0);"><span class="btn-label"><i class="fa fa-download"></i></span><%=LNG("Sorgula")%></a>
                        </div>

                        <div class="col-sm-1 col-md-12"><br />
                            <div style="float: right;">
                                <a class="btn btn-labeled btn-success btn-mini" href="javascript:void(0);" onclick="rapor_pdf_indir('departman_adam_saat_raporu');"><span class="btn-label"><i class="fa fa-download"></i></span><%=LNG("İndir")%> </a>&nbsp;&nbsp;<a class="btn btn-labeled btn-warning btn-mini" href="javascript:void(0);" onclick="rapor_pdf_yazdir('departman_adam_saat_raporu');"><span class="btn-label"><i class="fa fa-print"></i></span><%=LNG("Yazdır")%> </a>&nbsp;&nbsp;<a class="btn btn-labeled btn-primary btn-mini" href="javascript:void(0);" onclick="rapor_pdf_gonder('departman_adam_saat_raporu');"><span class="btn-label"><i class="fa fa-send "></i></span><%=LNG("Gönder")%> </a>
                            </div>
                        </div>
                    </div>
            ...
            <div id="adam_saat_tab">
                <script type="text/javascript">
                    $(function () {
                        departman_adam_saat_getir();
                    });
                </script>
            </div>
        </article>
