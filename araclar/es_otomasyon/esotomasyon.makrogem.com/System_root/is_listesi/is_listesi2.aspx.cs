...
public partial class System_root_is_listesi_is_listesi2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sayac_departman.CssClass = "input-sm select2";
        sayac_departman.Attributes.Add("style", "color: black; margin: 0; width:120px;");
        /*
       ayarlar.baglan();
       ayarlar.cmd.Parameters.Clear();
