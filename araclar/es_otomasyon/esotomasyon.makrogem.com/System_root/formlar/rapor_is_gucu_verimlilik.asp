...
<html lang="tr">
    ...
    <body>
        <table style="width:100%;">
            <tr>
                <td style="vertical-align:top; text-align:left;"><h2><%=LNG("PERSONEL VERİMLİLİK RAPORU")%></h2><span><%=LNG("Oluşturma Tarihi")%>&nbsp;:&nbsp;<%=now %></span></td>
                ...
                <tbody id="tbody">
                    ...
                    <tr class=" ustunegelince <%=klas %>">
                        <%
                            ...
                            toplam_hesap = cint(100-(((cdbl(toplam_dakika)-cdbl(cetvel("kaynak_toplam_dakika")))/cdbl(cdbl(toplam_dakika)))*100))
                    ...
                    <tr>
                        ...
                        <td class="gosterge_td alt_td ">
                            <% if trim(gosterim_tipi)="0" then %>
                            %<%=cint(en_toplam_hesap/satirsay) %>
                            <% elseif trim(gosterim_tipi)="1" then %>
                            %<%=cint(100-(en_toplam_hesap/satirsay)) %>
                            <% end if %>
                        </td>
