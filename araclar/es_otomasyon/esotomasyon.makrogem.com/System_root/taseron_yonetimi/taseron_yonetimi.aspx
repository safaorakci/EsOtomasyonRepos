<%@ Page Language="C#" AutoEventWireup="true" CodeFile="taseron_yonetimi.aspx.cs" Inherits="System_root_taseron_yonetimi_taseron_yonetimi" %>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><% Response.Write(LNG("Tedarikçi Listesi")); %></h5>
                </div>
                <div class="card-block">
                    <div id="firma_listesi">
                        <script>
                            $(function () {
                                firma_listesi('TASERON');
                            });
                        </script>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="row modal-footer" style="margin-top: 20px;">
                        <input type="button" onclick="firma_ekle('TASERON');" class="btn btn-primary" value="<% Response.Write(LNG("Firma Ekle")); %>" />
                    </div>
                </div>
            </div>
