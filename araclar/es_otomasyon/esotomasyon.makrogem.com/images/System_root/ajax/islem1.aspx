    ...
    <tbody>
        ...
        <asp:Panel ID="gorevler_kayitvar_panel" runat="server">
            <asp:Repeater ID="gorevler_repeater" runat="server">
                <ItemTemplate>
                    <tr>
            <td style="width:30px;"><%# DataBinder.Eval(Container.DataItem, "id") %></td>
        ...
        <div class="dt-responsive table-responsive">
         <table id="example" class="nowrap display projects-table responsive table table-striped table-bordered table-hover dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                    ...
                                    <asp:Panel ID="isler_is_yok_panel" runat="server">
                                        <tr>
                                            <td id="is_kayit_yok" varmi="yok" colspan="10" style="text-align: center; vertical-align: middle;"><% Response.Write(LNG("Kayıt Bulunamadı")); %></td>
                                        </tr>
                                        </asp:Panel>
                                        ...
                                        <tr class="details-control-tr" id="<%# DataBinder.Eval(Container.DataItem, "id") %>" role="row">
                                            ...
                                            <td class="sorting_1"><div class="tablo_is_adi"><%# DataBinder.Eval(Container.DataItem, "adi") %></div></td>
...
<div id="is_ara_form" class="smart-form validateform">
    ...
    <h4 class="modal-title"><% Response.Write(LNG("Yeni İş Ekle")); %></h4>
        </asp:Panel>
    ...
    <h4 class="modal-title"><% Response.Write(LNG("İş Arama")); %></h4>
            ...
            <div id="yeni_is_ekle_form">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="is_ajandada_goster" style="float:left; cursor:pointer; " ><input type="checkbox" class="js-switch" onclick="is_ajandada_goster_secim();" id="is_ajandada_goster" /> <% Response.Write(LNG("Ajanda da Göster")); %></label>
                                <span style="float:right;"><a href="javascript:void(0);" onclick="ekleme_detayli_giris();"><i class="fa fa-plus-square-o"></i> <% Response.Write(LNG("Detaylı Giriş")); %></a></span>
                            </div>
                        </div>

                        <div id="ekleme_detay" style="display:none;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class=" col-form-label"><% Response.Write(LNG("Öncelik")); %></label>
                                    <div>
                                ...
                                <div class="col-sm-4 dortlu" style="padding:0;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-primary">
                                            ...
                                            <input type="text" id="yeni_is_baslangic_tarihi" onkeyup="yeni_is_ekle_sure_hesap();" required class="takvimyap_yeni" style="padding-left:10px; max-width:110px;" value="<%Response.Write(DateTime.Today.ToShortDateString()); %>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 uclu" style="padding:0;">
                                ...
                                <div class="col-sm-4 dortlu" style="padding:0;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-primary">
                                            ...
                                            <input type="text" id="yeni_is_bitis_tarihi" onkeyup="yeni_is_ekle_sure_hesap();" required class="takvimyap_yeni" style="padding-left:10px; max-width:110px;" value="<%Response.Write(DateTime.Today.ToShortDateString()); %>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 uclu" style="padding:0;">
