...
<div id="is_yuku_birinci_ekran">
        ...
        <table>
            <tr>
                ...
                <td style="width: 200px; padding-right: 15px;">
                    <select name="yeni_is_yuku_gosterim_tipi" class="form-control select2" onchange="is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');" id="yeni_is_yuku_gosterim_tipi">
                ...
                <td style="width: 400px;">
                    <select name="yeni_is_yuku_proje_id" class="form-control select2" id="yeni_is_yuku_proje_id" onchange="is_yuku_gosterim_proje_sectim('<%=cdate(dongu_baslangic) %>', '<%=cdate(dongu_bitis) %>');">
                ...
                <td style="padding-left: 25px;">
                    <input type="button" onclick="isyuku_timeline_calistir();" class="btn btn-mini btn-rnd btn-primary" value="Timeline" /></td>
            </tr>
        </table>
    </div>
    <script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#yeni_is_yuku_gosterim_tipi, #yeni_is_yuku_proje_id").select2({
                dropdownParent: $("#modal_div2")
            });
        });
    </script>
